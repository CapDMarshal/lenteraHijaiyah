      ...
      <div className="rounded-2xl border-2 border-stone-900 bg-white px-6 py-6 shadow-[4px_4px_0_#9ca3af]">
        <div className="flex flex-wrap items-center justify-between gap-10">
          <div className="flex items-center gap-6">
            <button
              type="button"
              className="grid h-9 w-9 place-items-center rounded-lg border-2 border-stone-900 bg-white text-sm shadow-[3px_3px_0_#d14a35]"
            >
              ←
            </button>
            <div className="flex flex-wrap items-center ml-8 mr-8 gap-8">
          ...
          <button
            type="button"
            className="rounded-lg border-2 border-stone-900 bg-white px-6 py-2 text-xs font-semibold text-stone-900 shadow-[3px_3px_0_#d14a35]"
          >
            Semua Kelas
          </button>
        </div>
