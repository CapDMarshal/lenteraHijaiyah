    ...
    <>
      <section className="bg-[#f4efeb] relative z-50">
        <div className={`${sectionContainer} py-10 pb-16 sm:pb-32 relative`}>
          <div className="relative mx-auto max-w-2xl mt-8 space-y-16 text-center pt-16 pb-16">
            {/* Decorative Assets */}
          ...
          <div className="absolute left-1/2 -bottom-18 -translate-x-1/2 z-0">
      ...
      <section className="bg-white relative z-40">
        <div className={`${sectionContainer} pb-14 pt-24 sm:pt-32`}>
          <h2 className="text-center text-4xl font-black tracking-tight text-stone-900 sm:text-6xl">
            Tentang Kami
          </h2>
